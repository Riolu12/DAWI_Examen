...
<h1>Registra Cliente</h1>
	...
	<form action="registraCliente" id="id_form"> 
			...
			<div class="form-group">
				<label class="control-label" for="id_nombre">Nombre Cliente</label>
				<input class="form-control" type="text" id="id_nombre" name="cliente.nomCliente" placeholder="Ingrese el nombre">
			</div>
			<div class="form-group">
				<label class="control-label" for="id_apellido">Apellido Cliente</label>
				<input class="form-control" type="text" id="id_apellido" name="cliente.apeCliente" placeholder="Ingrese el apellido">
			</div>
			<div class="form-group">
				<label class="control-label" for="id_dni">DNI Docente</label>
				<input class="form-control" type="text" id="id_dni" name="cliente.dniDocente" placeholder="Ingrese el DNI">
			</div>
			<div class="form-group">
				<label class="control-label" for="id_fecha">Fecha Nacimiento</label>
				<input class="form-control" type="text" id="id_fecha" name="cliente.fecnacCliente" placeholder="Ingrese Fecha Nacimiento">
			</div>
			<div class="form-group">
...
<script type="text/javascript">
	$.getJSON("cargaTipo",{}, function(data,q,txt){
		$.each(data.lstTipo, function(key,value){
			$("#id_tipo").append("<option value='" + value.codTipo +  "'>" + value.nomTipo + "</option>")
		})
	});
</script>
